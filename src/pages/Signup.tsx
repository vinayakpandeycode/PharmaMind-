...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Mock signup
    setTimeout(() => {
      toast.success("Account created successfully! Welcome to PharmaMind.");
      navigate("/dashboard");
      setLoading(false);
    }, 1000);
  };
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-card/30 relative overflow-hidden">
        ...
        <div className="relative z-10 p-12 flex flex-col justify-center">
          ...
          <h1 className="font-display text-4xl font-bold mb-6">
            Start Your <br />
            <span className="text-gradient-primary">Research Journey</span>
          </h1>
          <p className="text-muted-foreground text-lg max-w-md">
            Join pharmaceutical teams using AI to discover new therapeutic opportunities faster than ever.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="glass-card rounded-2xl p-8">
            ...
            <p className="text-muted-foreground mb-8">Get started with PharmaMind platform</p>
